...
" "
	...
	$DriverHASHOutputFile = "C:\temp\$env:computername $(get-date -format "dd-MMM-yyy_HH:mm:ss" | ForEach-Object { $_ -replace ":", "_" })_System32_Driver_Hashes.csv"

	Function hashSYSTEM32 {
	...
	$SysWOW64HASHOutputFile = "C:\temp\$env:computername $(get-date -format "dd-MMM-yyy_HH:mm:ss" | ForEach-Object { $_ -replace ":", "_" })_SysWOW64_Hashes.csv"
	
	Function hashSYSWOW64 {
	$env:computername | out-file -Append $SysWOW64HASHOutputFile
	echo "SysWOW64 Driver Hashes" | out-file -Append $SysWOW64HASHOutputFile
...
$Counter ++
Write-Progress -Activity "Collecting Data" -Status "In progress: $Task"
$Task
}
